...
const journeyStages: JourneyStage[] = [
    {
        stage: "Nursery",
        images: ["/gallery/collegeimg.jpg", "/gallery/collegeimg.jpg", "/gallery/collegeimg.jpg"],
    },
    {
        stage: "LKG",
        images: ["/gallery/collegeimg.jpg", "/gallery/collegeimg.jpg", "/gallery/collegeimg.jpg"],
            ...
            <div className="container px-5 py-16 mx-auto">
                <div className="text-center mb-12">
                    ...
                    <p className="lg:w-2/3 mx-auto leading-relaxed text-base text-gray-600">
                        A glimpse of my journey from Nursery to IIT, capturing milestones,
                        medals, and memories along the way.
                    </p>
                </div>

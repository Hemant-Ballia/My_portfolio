      ...
      <div className="grid md:grid-cols-3 gap-8">
        { pricingTiers.map((tier, i) => (
          <motion.div
            ...
            className="bg-white dark:bg-[#0d1117]/60 backdrop-blur-md border border-gray-200 dark:border-gray-700 rounded-2xl p-6 shadow-lg hover:shadow-emerald-500/30 transition-transform duration-300 hover:-translate-y-2"
          >

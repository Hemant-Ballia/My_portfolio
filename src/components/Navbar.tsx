...
// import { usePathname } from 'next/navigation'; // <-- यह नया इंपोर्ट है

// // --- Icons ---
// const GithubIcon = () => (<svg xmlns="http://www.w3.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg>);
...
// const DownloadIcon = () => <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={ 2 } stroke="currentColor" className="w-5 h-5"><path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12 16.5m0 0L7.5 12m4.5 4.5V3" /></svg>;
...
//       <Image
//         src="/assets/pic.jpg"
//         alt="Hemant Chauhan's profile picture"
//         width={ 40 }
//         height={ 40 }
...
//     return 'dark';
//   });
//   const pathname = usePathname(); // <-- usePathname का उपयोग करें
...
//       className={ `sticky top-0 z-50 transition-all duration-300 bg-white/80 dark:bg-slate-900/80 backdrop-blur-lg ${isScrolled ? 'shadow-md border-b border-slate-200/50 dark:border-slate-800/50' : ''}` }
//     >
...
//               key={ label }
//               href={ href }
//               className={ `relative px-4 py-2 rounded-md text-sm font-medium transition-colors duration-300 ${pathname === href ? 'text-blue-500 dark:text-blue-400' : 'text-slate-700 dark:text-slate-300 hover:text-blue-500 dark:hover:text-blue-400'}` }
//             >
//               { label }
//               { pathname === href && (
//                 <motion.div
...
//             <a key={ label } href={ href } target="_blank" rel="noopener noreferrer" aria-label={ label } className="p-2 rounded-full text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
//               { icon }
//             </a>
//           )) }
//           <button
...
//           </button>
//           <a href="assets/resume.pdf" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold rounded-md text-white bg-gradient-to-r from-blue-500 to-purple-600 hover:opacity-90 transition-all shadow-md transform hover:scale-105">
//             <DownloadIcon /> Resume
//           </a>
//         </div>
